...
import 'package:latihan_mobile/lat_edukasi_6april/screen_page/page_login_api.dart';
  ...
  Future<List<Datum>?> getBerita() async {
    try {
      http.Response response = await http.get(
        Uri.parse("http://192.168.100.8/mobprolanjut/edukasi_server/getBerita.php"),
      );
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        backgroundColor: Colors.purple.shade900, // Start color of the gradient
        flexibleSpace: Container(
          decoration: BoxDecoration(
            gradient: LinearGradient(
              colors: [Colors.red.shade900, Colors.purple.shade600],
                            ...
                            child: Column(
                              ...
                              children: [
                                ClipRRect(
                                  ...
                                  child: Image.network(
                                    'http://192.168.100.8/mobprolanjut/edukasi_server/gambar_berita/${data.gambar}',
                                    fit: BoxFit.cover,
                                  ),
                                ),
                                Padding(
