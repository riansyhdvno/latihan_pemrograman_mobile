...
class _NotesScreenState extends State<NotesScreen> {
  ...
  Future<ModelNotes> fetchNotes() async {
    final response = await http.get(Uri.parse('http://192.168.18.21/mobprolanjut/notes/getNotes.php'));
  ...
  Future<void> addOrUpdateNote({required Datum note}) async {
    String url = note.id.isEmpty
        ? 'http://192.168.18.21/mobprolanjut/notes/addNotes.php'
        : 'http://192.168.18.21/mobprolanjut/notes/updateNotes.php';
  ...
  Future<void> deleteNote(String id) async {
    final response = await http.post(
      Uri.parse('http://192.168.18.21/mobprolanjut/notes/deleteNotes.php'),
      body: {'id': id},
    );
